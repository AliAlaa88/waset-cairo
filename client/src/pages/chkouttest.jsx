		...
		<div className="ckout-body">
			<div className="checkout-container">
				...
				<div className="dropdown-container">
					<label className="tour-selectlabel">
						Choose a Tourist Group if exist:
					</label>
					<select
				...
				<div className="summary">
					...
					<p className="ckout-totalcost">
						Total Cost: $
						{(tickets * cost - (discount / 100) * tickets * cost).toFixed(2)}
					</p>
				</div>
				<button className="ckout-btn" onClick={handleCheckout}>
					Checkout
				</button>
			</div>
		</div>
